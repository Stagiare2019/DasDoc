 ...
 */
final class Version20190529093104 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE famille_matiere (id INT NOT NULL, libelle VARCHAR(63) NOT NULL, abreviation VARCHAR(15) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE matiere (id INT NOT NULL, fk_famille_id INT NOT NULL, libelle VARCHAR(127) NOT NULL, abreviation VARCHAR(15) NOT NULL, PRIMARY KEY(id))');
